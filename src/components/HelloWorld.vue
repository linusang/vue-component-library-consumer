<script lang="ts" setup>
  ...
  import { SimpleButton } from "@linusang/vue-ui";
  interface Props {
    msg: string;
  }
...
<template>
  <div class="flex h-screen items-center justify-center">
    <div class="text-center">
      ...
      <SimpleButton
        class="bg-green-500 text-white disabled:bg-green-200"
        :is-processing="isProcessing"
        >this is from @linusang/vue-ui</SimpleButton
      >
      <button
        @click="toggleIsProcessing"
        class="rounded border border-gray-600 bg-gray-300 p-3 shadow-md"
      >
        Toggle IsProcessing
      </button>
